...
import { TDonateCreatedPayload } from "types/notifications";
...
interface DonateCreatedProps {
  notif: TNotificationTransform;
  fnClose: () => void;
}

const DonateCreated: FC<DonateCreatedProps> = ({ notif, fnClose }) => {
